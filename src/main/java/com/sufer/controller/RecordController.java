...
public class RecordController {
    ...
    public String newRecord(@RequestParam(name="patient_id")Integer patientId,
                            ...
                            @RequestParam(name="diseases_classification",required = false)String diseasesClassification,
                            @RequestParam(name="symptom",required = false)String symptom,
                            @RequestParam(name="onset",required = false)String onset,
                            @RequestParam(name="is_infectious",required = false)String isInfectious,
                            @RequestParam(name="chief_complaint",required = false)String chiefComplaint,
                            @RequestParam(name="present_illness",required = false)String presentIllness,
                            @RequestParam(name="past_illness",required = false)String pastIllness,
                            @RequestParam(name="personal_illness",required = false)String personalIllness,
                            @RequestParam(name="family_illness",required = false)String familyIllness,
                            @RequestParam(name="diagnose",required = false)String diagnose,
                            @RequestParam(name="doctor_advice",required = false)String doctorAdvice,
                            HttpSession session,
